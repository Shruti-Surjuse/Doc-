...
function Ending() {
  return (
    <div className='main flex p-10 h-screen justify-between '>
    <div className='left bg-white h-full w-full  flex flex-col justify-between'>
        <div className='left font-bold text-[5vw] w-1/2 leading-none tracking-tight uppercase'><h1>eye-<br/>opening</h1></div>
    ...
    <div className='right capitalize text-md w-1/2  -mr-72 '>
    <div className='right font-bold text-[5vw] w-1/2 leading-none tracking-tight uppercase'><h1>presentations</h1></div>
   
    <div className='one mt-10'>
        {["s:","instagram","behance","facebook","linkedin"].map((item,index)=>{
            return <div>
                   {index===1 && (<div className='mb-6'></div>)}
    ...
    <div className='third mt-8'>
        {["e:","hello@ochi.design"].map((item,index)=>{
            return <div>
                {index===1 && (<div className='mb-6 lowercase'></div>)}
                <h1  key={index}>{item}</h1>
            </div>
        })}
    </div>
    ...
    <div className='side w-1/2 pt-[15vw] capitalize'> 
